            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="mb-3 mt-3 col-md-4">
                        ...
                        <Select class="form-control" class="form-control" name="product_brand_id">
                            ...
                            <?php foreach ($brands as $brand): ?>
                                <option <?= $product['product_brand_id'] == $brand['id'] ? 'selected' : null ?> value="<?= $brand['id'] ?>">
                                    <?= $brand['name'] ?>
                                </option>
                            <?php endforeach ?>
                        </Select>
                    ...
                    <div class="mb-3 mt-3 col-md-4">
                        ...
                        <Select class="form-control" class="form-control" name="tags[]" multiple>
                            <?php foreach ($tags as $tag): ?>
                                <option <?= in_array($tag['id'],$idTagsProduct) ? 'selected' : null ?>  value="<?= $tag['id'] ?>">
                                    <?= $tag['name'] ?>
                                </option>
                            <?php endforeach ?>
                        </Select>
                    ...
                    <div class="mb-3 mt-3 col-md-4">
                        ...
                        <Select class="form-control" class="form-control" name="colors[]" multiple>
                            <?php foreach ($colors as $color): ?>
                                <option <?= in_array($color['id'],$idColorsForProduct) ? 'selected' : null ?> value="<?= $color['id'] ?>">
                                    <?= $color['name'] ?>
                                </option>
                            <?php endforeach ?>
                        </Select>
                    ...
                    <div class="mb-3 mt-3 col-md-4">
                        ...
                        <Select class="form-control" class="form-control" name="galleries[]" multiple>
                            <?php foreach ($galleries as $gallery): ?>    
                                <option <?= in_array($gallery['id'],$idGalleriesForProduct) ? 'selected' : null ?> value="<?= $gallery['id'] ?>">
                    ...
                    <div class="mb-3 mt-3 col">
                        ...
                        <textarea value="<?= isset($_SESSION['data']) ? $_SESSION['data']['description'] : null ?>" name="description" class="form-control" id="abc"  cols="30" rows="10"><?= $product['description'] ?></textarea>
                    </div>
                </div>
