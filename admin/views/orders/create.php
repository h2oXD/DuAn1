                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input
                                                    value="<?= isset($_SESSION['data']) ? $_SESSION['data']['frist_name'] : null ?>"
                                                    type="text" class="form-control" id="frist_name"
                                                    placeholder="Enter First name" name="frist_name">
                                            </div>
                                            <div class="mb-3 mt-3">
                                                <label for="last_name" class="form-label">Last name:</label>
                                                <input
                                                    value="<?= isset($_SESSION['data']) ? $_SESSION['data']['last_name'] : null ?>"
                                            ...
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input
                                                    value="<?= isset($_SESSION['data']) ? $_SESSION['data']['phone_number'] : null ?>"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input value="" type="text" class="form-control" id="note"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input
                                                    value="<?= isset($_SESSION['data']) ? $_SESSION['data']['order_date'] : null ?>"
                                                    type="datetime-local" class="form-control" id="order_date"
                                                    name="order_date">
                                            </div>
                                            <div class="mb-3 mt-3">
                                                <label for="status" class="form-label">Status:</label>
                                                <input
                                                    value="<?= isset($_SESSION['data']) ? $_SESSION['data']['status'] : null ?>"
                                                    type="number" class="form-control" id="status"
