                                ...
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            <div class="icon">
                                                <span>
                                                    <img src="<?= BASE_URL ?>assets/admin/src/assets/img/money-bag.png" alt="money-bag">
                                                </span>
                                            </div>
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-8.jpg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-12.jpg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-19.jpg"/>
                                            </div>
                        ...
                        <!-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-19.jpg" alt="avatar">
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/g-8.png" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-19.jpg" alt="avatar">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-6.jpg" alt="avatar">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-8.jpg" alt="avatar">
                                            <img src="<?= BASE_URL ?>assets/admin/src/assets/img/profile-3.jpg" alt="avatar">
                                        </div>
