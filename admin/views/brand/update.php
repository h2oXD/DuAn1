                ...
                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input value="<?= $brand['name'] ?>" type="text" class="form-control"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 mt-3">
                            ...
                            <input value="" type="text" class="form-control" id="product_id" placeholder="Enter product id" name="product_id">
                        </div>
                    </div>
                </div> -->
