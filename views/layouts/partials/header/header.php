              ...
              <div class="container d-flex">
                ...
                <div class="mega-menu__media col">
                  <div class="position-relative">
                    <img loading="lazy" class="mega-menu__img" src="<?= BASE_URL ?>/assets/images/mega-menu-item.jpg" alt="New Horizons">
      ...
      <div class="header-tools d-flex align-items-center">
        <div class="header-tools__item hover-container">
          ...
          <div class="search-popup js-hidden-content">
            <form action="https://uomo-html.flexkitux.com/Demo13/search_result.html" method="GET" class="search-field container">
