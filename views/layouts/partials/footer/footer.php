<footer class="footer footer_type_3 full-width_padding">
    <div class="footer-middle d-lg-flex align-items-center justify-content-between">
      <ul class="sub-menu__list list-unstyled d-sm-flex my-2">
        ...
        <li class="sub-menu__item px-3"><a href="?act=list-product" class="menu-link menu-link_us-s text-uppercase fw-semi-bold">Shop</a></li>
        ...
        <li class="sub-menu__item px-3"><a href="contact.html" class="menu-link menu-link_us-s text-uppercase fw-semi-bold">Contact</a></li>
      </ul>
