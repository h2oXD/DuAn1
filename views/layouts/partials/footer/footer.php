<footer class="footer footer_type_3 full-width_padding">
    <div class="footer-middle d-lg-flex align-items-center justify-content-between">
      <ul class="sub-menu__list list-unstyled d-sm-flex my-2">
        <li class="sub-menu__item px-3"><a href="<?= BASE_URL ?>" class="menu-link menu-link_us-s text-uppercase fw-semi-bold">Trang chủ</a></li>
        <li class="sub-menu__item px-3"><a href="?act=list_sp" class="menu-link menu-link_us-s text-uppercase fw-semi-bold">Sản phẩm</a></li>
        <li class="sub-menu__item px-3"><a href="?act=show_about" class="menu-link menu-link_us-s text-uppercase fw-semi-bold">About</a></li>
      </ul>
      <div class="d-flex align-items-center px-3 my-2">
        <span class="fw-semi-bold d-block me-4 pe-1">FOLLOW</span>
        <ul class="social-links list-unstyled d-flex flex-wrap mb-0">
          <li>
            <a href="https://www.facebook.com/" class="footer__social-link d-block p">
