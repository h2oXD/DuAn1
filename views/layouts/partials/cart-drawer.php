<div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
    ...
    <div class="aside-content cart-drawer-items-list">
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="<?= BASE_URL ?>/assets/images/cart-item-1.jpg" alt="">
          </a>
        </div>
      ...
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="<?= BASE_URL ?>/assets/images/cart-item-2.jpg" alt="">
          </a>
        </div>
        <div class="cart-drawer-item__info flex-grow-1">
      ...
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="<?= BASE_URL ?>/assets/images/cart-item-3.jpg" alt="">
          </a>
        </div>
        <div class="cart-drawer-item__info flex-grow-1">
