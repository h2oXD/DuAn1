    ...
    <div class="customer-forms__wrapper d-flex position-relative">
      <div class="customer__login">
        ...
        <form action="" method="POST" class="aside-content">
          ...
          <button class="btn btn-primary w-100 text-uppercase" name="login" value="login" type="submit">Log In</button>
      ...
      <div class="customer__register">
        ...
        <form action="" method="POST" class="aside-content">
          ...
          <button class="btn btn-primary w-100 text-uppercase" name="register" value="register" type="submit">Register</button>
