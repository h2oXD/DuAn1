            ...
            <div class="swiper-slide product-card product-card_style10">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="?act=chitiet&id=<?= $productsale['id'] ?>"><img loading="lazy" src="<?= $productsale['thumbnail'] ?>" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img"></a>
              ...
              <div class="pc__info position-relative d-flex flex-column align-items-center mb-3 mb-md-4 mb-xxl-5">
                <h6 class="pc__title text-uppercase fw-semi-bold"><a href="?act=chitiet&id=<?= $productsale['id'] ?>"><?= $productsale['title'] ?></a></h6>
