<section class="products-carousel full-width_padding">
      <h2 class="section-title text-uppercase text-center mb-1 mb-md-3 pb-xl-2 mb-xl-4">New <strong>Arrivals</strong></h2>
      ...
      <div class="position-relative">
        <div class="swiper-container js-swiper-slider"
          ...
          <div class="swiper-wrapper">
            <?php foreach($productarrival as $productarrival): ?>
            <div class="swiper-slide product-card product-card_style10">
              ...
              <div class="pc__info position-relative d-flex flex-column align-items-center mb-3 mb-md-4 mb-xxl-5">
                ...
                <span class="money price">$<?= $productarrival['sale'] ?></span>
                </div>
              </div>
            </div>
            <?php endforeach; ?>
