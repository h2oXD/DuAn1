<section class="swiper-container js-swiper-slider slideshow slideshow-lg"
      data-settings='{
        "autoplay": {
          "delay": 5000
        },
      ...
      <div class="container-fluid">
        <div class="position-relative">
          <a href="#section-collections-grid_masonry" class="slideshow-scroll d-none d-xxl-block position-absolute end-0 bottom-0 text_dash text-uppercase fw-medium text-white mb-4">Scroll</a>
        </div>
      </div>
    </section>